...
func main() {
	...
	mux.HandleFunc("GET /api/downloads/{id}", handler.GetDownload)
	mux.HandleFunc("POST /api/downloads/{id}/download", handler.IncrementDownload)
	mux.HandleFunc("POST /api/downloads/{id}/rate", handler.RateDownload)
	...
	writeMux.HandleFunc("POST /api/downloads", handler.CreateDownload)
	writeMux.HandleFunc("GET /api/bilibili/qrcode/status", handler.PollBilibiliQrcode)
	writeMux.HandleFunc("POST /api/bilibili/qrcode", handler.GenerateBilibiliQrcode)
	writeMux.HandleFunc("POST /api/bilibili/bind", handler.BindBilibiliAccount)
	writeMux.HandleFunc("GET /api/bilibili/status", handler.GetBilibiliBindStatus)
	...
	writeMux.HandleFunc("PUT /api/downloads/{id}", handler.UpdateDownload)
